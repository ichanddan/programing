let arr=['tony', 'hulk', 'blackvido','docter dom'];
console.log(arr);// befor using slice output
arr=arr.slice(2,3)
console.log(arr);// affter using slice output
// allways return new array no changes in old array
// but splice method is change origenal array
